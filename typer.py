...
# maube also add cursor movement later
# FOR NOW LETS JUST IMPLENT THE KEYBOARD TYPING FUNCTIONALITY AND BACKSPACE FUNCTIONALITY, THEN WE CAN ADD MORE FEATURES LATER
# then add logging 
